#!/usr/bin/env node
import { h as openAICodexAuthPath } from "./search-event-CT1m2qh0.js";
import { A as normalizeTrustedOrigin, B as openAICodexAuthStatus, R as loginOpenAICodex, _ as CODEX_CONNECT_VERSION, h as diagnoseOpenAICodex, k as OpenAICodexTrustedOriginsStore, z as logoutOpenAICodex } from "./src-C1rEwVd8.js";
...
async function run(argv) {
	...
	try {
		switch (action) {
			...
			case "repair-session": {
				const { repairOpenAICodexSessions } = await import("./session-repair-BKmnavyq.js");
